...
- **G6 深审入口预检(强制)**:这个任务是否要求**有预算的付费者逐个对象重复完成**(每个 SKU / 场址 / 批次 / 市场各做一次)?答否即弃——典型是"查一次某厂商新功能怎么配",读完即走、没有可卖之物(gate 记 G6;全文见闸门契约 G6「深审入口预检」。回测显示 75% 的 G3 否决本该死在这一问,它是最省钱的一道);
