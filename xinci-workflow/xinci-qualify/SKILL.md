...
python3 xinci-workflow/xinci-core/scripts/registrar.py transition \
  ...
  --income-score <1-20> --g6-passed-lines <subscription|advertising|subscription,advertising> \
