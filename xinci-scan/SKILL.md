...
4. **先跑 G0(合法性与安全),再查陷阱类别(G5)。** G0 是零成本推理检查:违法、违反 ToS、欺诈供血、规避工具方向直接弃;命中已知陷阱的候选直接跳 G3 验证,失败即弃,不读 SERP 结构。
5. **跑 G1,再 G2、G3、G4。** G1 一票否决且永不为省时间跳过。竞争判断读完整首页,禁止 top-3 定论。
